...
// Primeira cópia da transação na página 6 do extrato original
18/05/2026 RENTAB.INVEST FACILCRED* 8711655 0,01 2273,18

// Segunda cópia da transação sob a seção Últimos Lançamentos na página 7
...
function parseBradescoText(text) {
  ...
  // Deduplica transações idênticas (mesma data, descrição e valor - sem balance!)
